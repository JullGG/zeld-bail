...
exports.getBotJid = exports.jidNormalizedUser = exports.isJidBot = exports.isJidNewsletter = exports.isJidNewsLetter = exports.isJidStatusBroadcast = exports.isJidGroup = exports.isJidBroadcast = exports.isLidUser = exports.isJidUser = exports.areJidsSameUser = exports.jidDecode = exports.jidEncode = exports.META_AI_JID = exports.STORIES_JID = exports.PSA_WID = exports.SERVER_JID = exports.OFFICIAL_BIZ_JID = exports.S_WHATSAPP_NET = void 0;
...
// Renvy Bail Fast Plus: helper alias, same function with modern spelling
const isJidNewsletter = isJidNewsLetter;
exports.isJidNewsletter = isJidNewsletter;
// Renvy Bail Fast Plus: Meta AI / bot jid helpers
const botRegexp = /^1313555\d{4}$|^131655500\d{2}$/;
const isJidBot = (jid) => (jid && (jid.endsWith('@bot') || (botRegexp.test(String(jid).split('@')[0]) && jid.endsWith('@c.us'))));
...
const getBotJid = (jid) => {
    ...
    // common Meta AI default fallback
    if (user === '0') return exports.META_AI_JID;
    return jid;
};
